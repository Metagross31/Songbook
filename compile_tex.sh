...
while test $# -gt 0; do
    case "$1" in
        -h|--help)
            ...
            echo "This compiles the file main.tex to a pdf and saves it as output/PROJECT.pdf"
            echo "In order for it to find the correct directories, it has to be run directly from the projects root directory."
            echo "It also automatically cleans up other files generated by the compiler, other than the PROJECT.pdf file."
            echo ""
            echo "Usage:"
            echo "./compile_tex.sh [OPTIONS]"
            echo ""
            echo ""
